 ...
 * @author shrom
 */
public class GFIPMCertificateValidatorWSP implements CertificateValidator, ValidatorExtension {

    private static final Logger log =
            Logger.getLogger(GFIPMCertificateValidatorWSP.class.getName());
    ...
    public GFIPMCertificateValidatorWSP() throws XWSSecurityException, InstantiationException, IllegalAccessException {
...
//    }
    ...
    private boolean isAuthorized(X509Certificate certificate) {
        ...
        //GFIPM Entity (entityId) should belong to WSC or IDP. The IDP case is 
        //possible because this validator also provides check for the certificate 
        //used to sign SAML Assertion, therefore this code will be executed 
        //to validate a certificate for both: WSC and IDP.
        if (tf.isWebServiceProvider(entityId)) {
            log.log(Level.WARNING, "Entity connecting to this WSP should be listed as WSC or IDP in the GFIPM Trust Fabric, entity id :" + entityId);
            return false;
        }
