...
/**
 * Class that supports KeyStoreCallback handler
//<wsp:Policy wsu:Id="NewWebServicePortBindingPolicy">
// <wsp:ExactlyOne>
// <wsp:All>
// <sc:KeyStore
// xmlns:sc="http://schemas.sun.com/2006/03/wss/client" wspp:visibility="private"
// callbackHandler="KeyStoreCallbackHandler" alias="xws-security-client"/>
// <sc:TrustStore
// xmlns:sc="http://schemas.sun.com/2006/03/wss/client" wspp:visibility="private"
// callbackHandler="TrustStoreCallbackHandler" peeralias="xws-security-server"/>
// </wsp:All>
// </wsp:ExactlyOne>
// </wsp:Policy>
// 
...
public class KeyStoreCallbackHandler implements CallbackHandler {
    ...
    public KeyStoreCallbackHandler() {
        System.out.println("Keystore CBH.CTOR() Called..........");
            InputStream is = null;
            try {
                keyStore = KeyStore.getInstance("JKS");
                //InputStream inputStream = this.getClass().getClassLoader().getResourceAsStream("META-INF/system.properties");  
                URL keystoreURL =  this.getClass().getResource("cureidpm2-keystore.jks"); 
            ...
            if (callbacks[i] instanceof KeyStoreCallback) {
                ...
                try {
                    PrivateKeyCallback cb = (PrivateKeyCallback) callbacks[i];
                     System.out.println("PrivateKEyCallback Props are");
                    print(cb.getRuntimeProperties());
