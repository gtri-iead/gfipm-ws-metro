...
//public class STSImpl extends com.sun.xml.ws.trust.impl.IssueSamlTokenContractImpl    
    @Resource
    protected WebServiceContext context;
    private static final Logger logger = Logger.getLogger(STSImpl.class.getName());
...
//        com.sun.xml.ws.transport.http.client.HttpTransportPipe.dump = true;
        if (DEBUG) {
            logger.log(Level.FINEST, "STS: STSImpl : initialized");
        }
    }
    ...
    protected MessageContext getMessageContext() {
        if (DEBUG) {
            logger.log(Level.FINEST, "STS: Inside STSImpl::getMessageContext");
        }
